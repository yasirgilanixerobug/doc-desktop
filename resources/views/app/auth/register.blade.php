...
{{--                            </div>--}}
                            <hr>
                            <form class="frm-top-down" action="{{ route('auth.clinicRegister') }}" method="post" style="margin-top: 100px">
                                @csrf
                                <div class="form-group">
                                    <input type="text" name="business_name" class="requiredField form-control @error('business_name') is-invalid @enderror" id="business_name" value="{{ old('business_name') }}" placeholder="Business Name" required>
                                    @error('business_name')
                                    <span class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    <input type="text" name="name" class="requiredField form-control @error('name') is-invalid @enderror" id="name" value="{{ old('name') }}" placeholder="Your Name" required>
                                    @error('name')
                                    <span class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="forgotten">
                                <a href="{{ route('auth.clinicLoginForm') }}"><span class="link-span">already register</span></a><br>
                                <!-- <a href="{{ route('auth.patientRegisterForm') }}"><span class="link-span">Register as a patient</span></a> -->
                            </div>
