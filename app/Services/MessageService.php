...
class MessageService {
    ...
    function getRequestReviewMessage(array $data): array
    {
        ...
        $reviewUrl = route('reviewFollowUp.checkForm', ['slug' => $data['slug']]);

        $patientMessage = "Thank you for choosing $clinic for your health care. Please let us know how was your experience with $providerName on $date at $locationName \n.
